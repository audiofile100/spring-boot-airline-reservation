...
<body>
	...
	<div class="container bg-light shadow bg-light rounded">
		<frm:form action="searchFlights" method="POST" modelAttribute="search">
			...
			<div class="row">
				<div class="col col-3">
					<frm:input class="form-control form-control-lg mb-4" type="date"
						path="depart" />
				</div>
				...
				<div class="col col-sm-2">
					<frm:input class="form-control form-control-lg mb-4" type="number"
						min="1" max="100" step="1" path="tickets" /> <frm:errors path="tickets" cssClass="error" />
				</div>

				<div class="col col-4">
					<button type="submit" class="btn btn-primary mb-4 shadow rounded"
